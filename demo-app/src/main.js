...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/library-desk",
  "readmeUrl": "https://github.com/Justin21523/library-desk#readme",
  ...
  "architecture": "This case study is generated from the portfolio catalog pipeline using README, Git metadata, package/build configuration, and media signals. The final architecture narrative still needs source-level review. Current detected technology signals include: Java, Maven.",
  ...
  "features": [
    "Detected technical signals: Java, Maven,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Java, Maven,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
